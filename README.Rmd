...
potential outcomes. Since we only observe $Y(1)$ for treated units (where $D=1$) and
$Y(0)$ for control units (where $D=0$), the ATE is not point-identified without assumptions.

By the law of iterated expectations:

$$E[Y(1)] = E[Y|D=1] \cdot P(D=1) + E[Y(1)|D=0] \cdot P(D=0)$$

The term $E[Y(1)|D=0]$ — the mean treated outcome for those who were not treated — is unobservable. However, if outcomes are bounded ($Y \in [y_{min}, y_{max}]$), we can bound this term and thus bound $E[Y(1)]$:
